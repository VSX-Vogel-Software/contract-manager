...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed inset-x-0 bottom-0 z-[100] mx-auto flex max-h-screen w-full flex-col-reverse items-stretch gap-2 p-4 sm:max-w-[420px]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description
    ref={ref}
    className={cn("mt-1 text-sm break-words opacity-90", className)}
    {...props}
  />
))
